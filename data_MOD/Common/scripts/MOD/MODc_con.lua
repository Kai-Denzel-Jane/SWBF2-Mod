...
function ScriptPostLoad()
    ...
    conquest.OnStart = function(self)
    	conquest.goal1 = AddAIGoal(CLO, "Defend", 30, "gatepanel")
		...
		conquest.goal6 = AddAIGoal(CLO, "Defend", 10, "woodl")
		conquest.goal7 = AddAIGoal(CLO, "Defend", 10, "woodc")
		conquest.goal8 = AddAIGoal(CLO, "Defend", 10, "woodr")
	end
...
--    AddWalkerType(2, 2) -- 2 spider walkers with 2 leg pairs each
    ...
    ReadDataFile("dc:MOD\\kas2.lvl", "kas2_con")

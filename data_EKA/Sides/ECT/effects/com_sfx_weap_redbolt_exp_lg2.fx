	...
	Geometry()
	{
		...
		ParticleEmitter("BlackSmoke")
		{
			...
			Spawner()
			{
				Spread()
				{
					PositionX(-1.4000,1.4000);
					PositionY(-1.4000,1.4000);
					PositionZ(-1.4000,1.4000);
				}
				Offset()
				{
					PositionX(-0.0700,0.0700);
					PositionY(-0.0700,0.0700);
					PositionZ(-0.0700,0.0700);
				}
				PositionScale(0.0000,0.0000);
				VelocityScale(1.4000,1.4000);
				InheritVelocityFactor(0.2000,0.2000);
				Size(0, 0.7000, 0.9800);

ParticleEmitter("Shockwave")
{
	...
	ParticleEmitter("Explosion")
	{
		...
		Spawner()
		{
			...
			PositionScale(-0.7800,-0.7800);
			VelocityScale(2.5000,3.5000);
			InheritVelocityFactor(0.0000,0.0000);

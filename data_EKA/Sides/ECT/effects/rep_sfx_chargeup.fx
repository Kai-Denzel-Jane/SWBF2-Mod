ParticleEmitter("ChargeGlow")
{
	...
	Transformer()
	{
		...
		{
			LifeTime(0.1000)
			Reach(255.0000,50.0000,0.0000,128.0000);
			Next()
			{
				LifeTime(0.4000)
	...
	Geometry()
	{
		...
		ParticleEmitter("Smoke")
		{
			...
			Spawner()
			{
				...
				Red(0, 000.0000, 000.0000);
				Green(0, 040.0000, 055.0000);
	...
	ParticleEmitter("Flare")
	{
		...
		Spawner()
		{
			...
			Red(0, 005.0000, 005.0000);
			Green(0, 022.0588, 022.0588);
			Blue(0, 199.000, 255.000);
			Alpha(0, 0.0000, 0.0000);

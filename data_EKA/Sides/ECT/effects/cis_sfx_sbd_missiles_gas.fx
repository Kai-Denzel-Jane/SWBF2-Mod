ParticleEmitter("Spark_Emitter")
{
	...
	Spawner()
	{
		...
		Size(0, 1.2500, 1.3000);
		Red(0, 204.0000, 204.0000);
		...
		ParticleEmitter("Flare")
		{
			...
			ParticleEmitter("BlackSmoke")
			{
				...
				Spawner()
				{
					...
					Red(0, 94.0000, 94.0000);
					Green(0, 74.0000, 74.0000);
					Blue(0, 04.0000, 04.0000);
				...
				Transformer()
				{
					...
					{
						LifeTime(1.0000)
						Accelerate(0.0000, -0.0300, 0.0000);
					}
					Size(0)
					{
						LifeTime(1.8000)

ParticleEmitter("Smoke")
{
	...
	ParticleEmitter("Spark_Emitter")
	{
		...
		Transformer()
		{
			...
			{
				LifeTime(0.0500)
				Reach(100.0000,50.0000,200.0000,120.0000);
				Next()
				{
					LifeTime(0.1000)
					Reach(100.0000,50.0000,200.0000,20.0000);
				}
			}
		}
		Geometry()
		...
		ParticleEmitter("Flare")
		{
			...
			Transformer()
			{
				...
				{
					LifeTime(0.1000)
					Reach(100.0000,50.0000,255.0000,0.0000);
				}
			}
			Geometry()
			{

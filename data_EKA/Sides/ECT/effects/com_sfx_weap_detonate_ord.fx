ParticleEmitter("Smoke")
{
	...
	ParticleEmitter("Flare1")
	{
		...
		Spawner()
		{
			...
			Size(0, 0.0900, 0.1400);
			Red(0, 0.0000, 255.0000);
			Green(0, 0.0000, 255.0000);
		...
		ParticleEmitter("Flare2")
		{
			...
			Transformer()
			{
				...
				{
					LifeTime(0.1000)
					Move(25.0000,0.0000,255.0000,0.0000);
				}
			}
			Geometry()
			{
			...
			ParticleEmitter("Flare3")
			{
				...
				Transformer()
				{
					...
					{
						LifeTime(0.1000)
						Move(100.0000,0.0000,255.0000,0.0000);
					}
				}
				Geometry()
				{

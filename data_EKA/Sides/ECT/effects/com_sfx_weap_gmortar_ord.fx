ParticleEmitter("Smoke")
{
	...
	Spawner()
	{
		...
		Green(0, 188.0000, 200.0000);
		Blue(0, 25.0000, 55.0000);
	...
	Transformer()
	{
		...
		{
			LifeTime(0.1000)
			Move(50.0000,30.0000,0.0000,32.0000);
			Next()
			{
				LifeTime(3.9000)
	...
	ParticleEmitter("Flare3")
	{
		...
		Spawner()
		{
			...
			Size(0, 0.1200, 0.1700);
			Red(0, 238.0000, 255.0000);
			Green(0, 166.0000, 225.0000);
			Blue(0, 15.0000, 55.0000);
		...
		Transformer()
		{
			...
			{
				LifeTime(0.1000)
				Move(0.0000,0.0000,67.0000,0.0000);
			}
		}
		Geometry()
		{

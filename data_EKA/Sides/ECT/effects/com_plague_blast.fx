ParticleEmitter("Distortion")
{
	...
	Geometry()
	{
		...
		BlurRes(1.0000);
		Type("PARTICLE");
		Texture("com_sfx_plaguemist");
	}
	ParticleEmitter("GreenSmoke")
	{
		MaxParticles(04.0000,04.0000);
		StartDelay(0.0000,0.0000);

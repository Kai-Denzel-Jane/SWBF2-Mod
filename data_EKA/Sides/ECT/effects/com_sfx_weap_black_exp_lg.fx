		...
		Geometry()
		{
			...
			ParticleEmitter("Smoke")
			{
				...
				Spawner()
				{
					...
					PositionScale(0.0000,0.0000);
					VelocityScale(1.7500,1.7500);
					InheritVelocityFactor(0.7500,0.2500);
					Size(0, 2.7500, 3.1250);
					Hue(0, 0.0000, 0.0000);
					Saturation(0, 0.0000, 0.0000);
					Value(0, 20.0000, 50.0000);
					Alpha(0, 0.0000, 128.0000);
					StartRotation(0, 0.0000, 360.0000);
					RotationVelocity(0, -60.0000, 60.0000);
					FadeInTime(0.0000);
				}
				Transformer()
				{
					...
					Color(0)
					{
						...
						{
							LifeTime(1.8000)
							Move(16.000,16.000,120.0000,-255.0000);
						}
					}
				}
				Geometry()
				{
					...
					ParticleEmitter("BlackSmoke")
					{
						...
						Spawner()
						{
							Spread()
							{
								PositionX(-4.9375,4.9375);
								PositionY(-4.9375,4.9375);
								PositionZ(-4.9375,4.9375);
							}
							Offset()
							{
								PositionX(-1.1970,1.1970);
								PositionY(-1.1970,1.1970);
								PositionZ(-1.1970,1.1970);
							}
							PositionScale(0.0000,0.0000);
							VelocityScale(5.9375,5.9375);
							InheritVelocityFactor(0.8000,0.8000);
							Size(0, 2.9688, 7.7563);
					...
					Geometry()
					{
						...
						ParticleEmitter("BlackSmoke")
						{
							...
							Spawner()
							{
								Spread()
								{
									PositionX(-6.9375,6.9375);
									PositionY(-6.9375,6.9375);
									PositionZ(-6.9375,6.9375);
								}
								Offset()
								{
									PositionX(-0.3970,0.3970);
									PositionY(-0.3970,0.3970);
									PositionZ(-0.3970,0.3970);
								}
								PositionScale(0.0000,0.0000);

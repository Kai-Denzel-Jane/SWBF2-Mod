ParticleEmitter("ChargeGlow")
{
	...
	Transformer()
	{
		...
		{
			LifeTime(0.1000)
			Reach(60.0000,200.0000,0.0000,128.0000);
			Next()
			{
				LifeTime(0.4000)
				Reach(60.0000,225.0000,0.0000,255.0000);
			}
		}
	}
	Geometry()
	...
	ParticleEmitter("Flare")
	{
		...
		Spawner()
		{
			...
			Red(0, 120.0000, 120.0000);
			Green(0, 102.0000, 102.0000);
			Blue(0, 25.0000, 45.0000);
			Alpha(0, 0.0000, 0.0000);

ParticleEmitter("Smoke")
{
	...
	ParticleEmitter("Heat")
	{
		...
		Spawner()
		{
			...
			Green(0, 004.0000, 033.0000);
			Blue(0, 108.000, 200.0000);
			Alpha(0, 128.0000, 255.0000);
		...
		Geometry()
		{
			...
			ParticleEmitter("BlackSmoke")
			{
				...
				Spawner()
				{
					...
					Red(0, 094.0000, 095.0000);
					Green(0, 202.0000, 209.0000);
					Blue(0, 045.000, 050.000);
					Alpha(0, 0.0000, 0.0000);
					StartRotation(0, -20.0000, 20.0000);
					RotationVelocity(0, -20.0000, 20.0000);
					FadeInTime(0.0000);
		...
		ParticleEmitter("Flames")
		{
			...
			ParticleEmitter("Embers")
			{
				...
				Spawner()
				{
					...
					Red(0, 255.0000, 255.0000);
					Green(0, 008.0000, 008.0000);
					Blue(0, 0.0000, 221.0000);
				...
				ParticleEmitter("Sparks")
				{
					...
					Spawner()
					{
						...
						Red(0, 255.0000, 255.0000);
						Green(0, 004.0000, 004.0000);
						Blue(0, 232.000, 232.000);
						Alpha(0, 0.0000, 0.0000);

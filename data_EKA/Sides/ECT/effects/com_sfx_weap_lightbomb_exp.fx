ParticleEmitter("Radiation")
{
	...
	ParticleEmitter("Flare")
	{
		...
		Spawner()
		{
			...
			Green(0, 220.0000, 255.0000);
			Blue(0, 200.0000, 220.0000);
		...
		ParticleEmitter("Flare")
		{
			...
			ParticleEmitter("Sparks")
			{
				...
				Spawner()
				{
					...
					Red(0, 238.0000, 238.0000);
					Green(0, 70.0000, 70.0000);
					Blue(0, 116.0000, 116.0000);
				...
				Transformer()
				{
					...
					{
						LifeTime(1.0000)
						Move(238.0000,70.0000,116.0000,-255.0000);
					}
				}
				Geometry()
				{

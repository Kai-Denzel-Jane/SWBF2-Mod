...
--                             "cis_walk_spider",
    ...
    SetupTeams{
        ...
        rep = {
            ...
            units = 96,
            reinforcements = 1000,
            soldier = {"rep_inf_ep3_rifleman",1, 16},
            assault = {"rep_inf_ep3_rocketeer",1, 16},
            engineer = {"rep_inf_ep3_engineer",1, 16},
            sniper  = {"rep_inf_ep3_sniper_felucia",1, 16},
            officer = {"ect_inf_ARF_Trooper",1, 16},
            special = {"rep_inf_ep3_jettrooper",1, 16},
        ...
        cis = {
            ...
            units = 96,
            reinforcements = 1000,
            soldier = {"cis_inf_rifleman",1, 16},
            assault = {"cis_inf_rocketeer",1, 16},
            engineer = {"cis_inf_engineer",1, 16},
            sniper  = {"cis_inf_sniper",1, 16},
            officer   = {"cis_inf_officer",1, 16},
            special = {"cis_inf_droideka",1, 16},
        }
    }
    ...
    -- AddUnitClass(REP, "ect_inf_ARF_Trooper", 1, 8)
...
--    AddWalkerType(2, 2) -- 2 spider walkers with 2 leg pairs each
    ...
    ReadDataFile("dc:EKA\\kas2.lvl", "kas2_con")
